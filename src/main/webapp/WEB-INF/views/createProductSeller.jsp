...
<div id="page">
	...
	<h1>Add Products</h1>
	<form:form action="${contextPath}/product/create" 
	commandName="selleradd" method="post" enctype="multipart/form-data">
		
        Name:<form:input path="name" size="30" required="required" />
        <font color="red"><form:errors path="name" /></font></td>
		<br>
		Category:<form:input path="category" size="30" required="required" />
		...
		<br>
		Create Album:<form:input path="filename" size="30" /><font color="red">
		<form:errors path="filename" /></font></td>
		<br />
