...
<p> Your Products have been approved </p>

<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
	<form:form action="${contextPath}/logout/admin" method="post">
			...
			<div id="footerblurb">
				<div id="footerblurb-inner">
					...
					<div class="column">
						...
						<p><script>If you like it Just Buy it</script></p>
					</div>	
					<div class="column">
						<h2><span>Think!</span></h2>
						<p><script>Tomorrow never comes...Buy it today</script></p>
					</div>
					<div class="column">
						<h2><span>Thought of the day</span></h2>
						<p><script>It may get outfashioned tomorrow</script></p>
					</div>			
